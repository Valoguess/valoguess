  ...
  return (
    <header className="w-full max-w-5xl relative z-10 flex items-center justify-between shrink-0 mb-6 md:mb-0">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link
          href="/lobby"
          className="text-xs font-semibold text-zinc-400 hover:text-white transition px-3.5 py-1.5 rounded-lg border border-white/10 bg-white/[0.03] hover:bg-white/[0.08]"
        >
          Skip to Lobby
        </Link>
      </div>
